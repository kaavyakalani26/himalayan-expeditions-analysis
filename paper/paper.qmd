...
I use data from @Cookson which are sourced from The Himalayan Expedition records (@Salisbury), to understand these factors and trends. This is done by leveraging a Bayesian Logistic Regression model and then predicting the probability of a successful attempt over various demographic and environmental factors.
...
## Analysis Dataset
The raw datasets were obtained from @Cookson. I chose the ones cleaned for Himalayan expeditions. Cookson got his datasets from The Himalayan Database (@Salisbury). 
